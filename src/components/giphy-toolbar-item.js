...
export default (
  <div class="gl-inline-flex gl-align-middle" data-testid="giphy-toolbar-item">
    <div
      class="gl-disclosure-dropdown content-editor-table-dropdown gl-mr-2 gl-new-dropdown"
    ...
    >
      ...
      <div class="gl-new-dropdown-container">
        <div
          id="base-dropdown-68"
          data-testid="base-dropdown-menu"
          class="!gl-w-75 gl-new-dropdown-panel !gl-block gl-new-dropdown-panel-fluid-width gl-absolute"
          style={{
            left: 'auto',
            right: '32px',
            top: '40px',
